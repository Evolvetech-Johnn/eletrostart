        ...
        <div className="lg:hidden fixed inset-0 top-[110px] bg-white z-[100] overflow-y-auto pb-20">
          <div className="flex flex-col">
            ...
            <div className="mt-4 px-6 space-y-4">
              <Link
                to="/"
                className="block py-2 text-primary font-bold uppercase text-sm"
              ...
              <Link
                to="/products"
                className="block py-2 text-gray-700 font-bold uppercase text-sm"
                onClick={() => setIsMenuOpen(false)}
              >
                Produtos
              </Link>
              ...
              <Link
                to="/contact"
                className="block text-center bg-secondary text-white rounded-md py-3 font-bold shadow-md uppercase text-sm"
                onClick={() => setIsMenuOpen(false)}
              >
                Fale Conosco
              </Link>
