...
const saveOrderToHistory = (order: {
  ...
  try {
    ...
    localStorage.setItem("my_orders", JSON.stringify(limitedOrders));
  } catch (e) {
    ...
    try {
      ...
      const orderData = {
        customer: {
          ...
          doc: "", // Não coletado no form simplificado
        },
        address: {
          zip: formData.cep,
        ...
        items: cart.map((item) => ({
          ...
          // variantId: item.variant?.id, // Add if backend supports variantId
        })),
        paymentMethod: paymentMethod,
        notes: "",
      };

      // 2. Enviar para API (tenta salvar no banco)
      ...
      try {
        ...
        // Não bloqueia o fluxo se a API falhar (fallback para WhatsApp apenas)
      }
      ...
      alert(
        "Ocorreu um erro ao processar seu pedido. Por favor, tente novamente ou entre em contato pelo WhatsApp.",
      );
    } finally {
      ...
      <div className="bg-[#222998] text-white py-8">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-xs uppercase font-bold tracking-widest mb-4 opacity-60">
            ...
            <Link to="/products" className="hover:text-white/80">
              Produtos
            </Link>
            <ChevronRight size={12} />
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 font-medium">
                    (Opcional - preencha se desejar entrega)
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentMethod === "pix" ? "bg-primary text-white" : "bg-gray-100 text-gray-500"}`}
                    >
                      <QrCode size={24} />
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentMethod === "boleto" ? "bg-primary text-white" : "bg-gray-100 text-gray-500"}`}
                    >
                      <FileText size={24} />
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentMethod === "cartao" ? "bg-primary text-white" : "bg-gray-100 text-gray-500"}`}
                    >
                      <CreditCard size={24} />
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${paymentMethod === "whatsapp" ? "bg-primary text-white" : "bg-gray-100 text-gray-500"}`}
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <div className="flex items-center gap-1">
                          <button
                            onClick={() =>
                              decrementQuantity(item.id, item.variant)
                            }
                          ...
                          <button
                            onClick={() =>
                              incrementQuantity(item.id, item.variant)
                            }
