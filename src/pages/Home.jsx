    ...
    const loadData = async () => {
      try {
        ...
        if (categoriesRes.success && Array.isArray(categoriesRes.data)) {
          loadedCategories = categoriesRes.data.map((cat) => ({
            ...cat,
        ...
        if (productsRes.success && Array.isArray(productsRes.data)) {
          ...
          // First, iterate through categories to ensure category order/priority if desired,
          // or iterate through products to just pick what's available.
          // Let's iterate through products to find unique categories.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="relative h-64 rounded-3xl overflow-hidden group shadow-lg">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex flex-col justify-center p-10 text-white">
              ...
              <p className="mb-6 opacity-90 italic">
                Design e tecnologia para sua casa
              </p>
              <Link
                to="/products?category=iluminacao"
                className="bg-white text-primary w-fit px-6 py-2 rounded-full font-bold uppercase text-xs tracking-widest hover:bg-gray-100 transition-colors shadow-lg"
              >
                Confira
              </Link>
            </div>
          ...
          <div className="relative h-64 rounded-3xl overflow-hidden group shadow-lg">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#222998]/80 to-transparent flex flex-col justify-center p-10 text-white">
              ...
              <p className="mb-6 opacity-90 italic">
                Proteção elétrica certificada
              </p>
              <Link
                to="/products?category=protecao"
                className="bg-white text-[#222998] w-fit px-6 py-2 rounded-full font-bold uppercase text-xs tracking-widest hover:bg-gray-100 transition-colors shadow-lg"
              >
                Saiba Mais
              </Link>
            </div>
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="text-white text-center md:text-left">
              ...
              <p className="text-blue-100 italic">
                Assine nossa newsletter e receba ofertas exclusivas em primeira
                mão.
              </p>
            </div>
            <form className="w-full md:w-auto flex flex-col sm:flex-row gap-4">
              ...
              />
              <button className="bg-secondary hover:bg-red-700 text-white px-10 py-4 rounded-full font-black uppercase tracking-widest transition-all shadow-xl hover:scale-105">
                Assinar
              </button>
            </form>
          </div>
