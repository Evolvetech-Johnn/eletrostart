        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-xl mb-8 text-blue-100 max-w-lg">
              Soluções completas em materiais elétricos e energia solar para
              residências, empresas e indústrias. Qualidade e confiança que você
              precisa.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Link
                to="/contact"
                className="px-8 py-3 bg-secondary text-white font-bold rounded-lg hover:bg-red-700 transition-colors text-center"
              >
                Solicitar Orçamento
              </Link>
              <Link
                to="/products"
                className="px-8 py-3 bg-white text-brand-blue font-bold rounded-lg hover:bg-gray-100 transition-colors text-center"
              >
                Ver Produtos
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Linha completa de produtos para instalações.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Instalações e manutenção para o seu lar.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Soluções de alta potência e automação.
              </p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-all text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Sustentabilidade e economia na sua conta.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Navegue pelo nosso catálogo de produtos e encontre tudo o que
            precisa para sua instalação elétrica.
          </p>
          <Link
            to="/products"
            className="px-8 py-3 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition-colors inline-block"
          >
