...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Enviar apenas para a API (Backend Centralizado)
      // O backend cuidará de salvar no MongoDB e notificar canais externos se necessário
      const success = await sendToAPI(formData);
      ...
      <div className="bg-[#222998] text-white py-20 relative overflow-hidden">
        ...
        <div className="layout-container relative z-10">
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl font-medium italic">
            Estamos prontos para dimensionar seu projeto elétrico ou solar.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-primary p-8 rounded-[32px] shadow-xl shadow-primary/20 text-white">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://web.facebook.com/eletro.start.1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center hover:bg-white/20 transition-all"
                >
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 md:p-12 rounded-[40px] shadow-xl shadow-blue-900/5">
              <h2 className="text-3xl font-black text-gray-900 uppercase mb-2 tracking-tight">
                Envie uma Mensagem
              </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Orçamento de Material">
                      Orçamento de Material
                    </option>
                    <option value="Como achar o codigo de rastreio">
                      Como achar o código de rastreio
                    </option>
