...
import { 
  ShoppingBag, Search, Eye, Loader2, AlertCircle, Calendar, DollarSign, User
} from 'lucide-react';
  ...
  return (
    <AdminLayout title="Pedidos" subtitle="Gerencie as vendas da loja">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-6">
        <form onSubmit={onSearchSubmit} className="flex gap-2 flex-1 w-full md:max-w-md">
          ...
          <button type="submit" className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-700">
            Buscar
          </button>
        </form>
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="px-6 py-3 font-medium text-gray-500 text-sm">Cliente</th>
                <th className="px-6 py-3 font-medium text-gray-500 text-sm">Data</th>
                ...
                <th className="px-6 py-3 font-medium text-gray-500 text-sm text-right">Ações</th>
              </tr>
            </thead>
